...
We have access to *Jacaranda copaia* allometry data from Helene collected on BCI that we can use to quantify the relationship between DBH and crown size.
